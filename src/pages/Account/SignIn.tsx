...
import { axiosPost } from "@/components/APIs/AxiosPost";
...
export default function SingIn() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    context.setToken(data.data.access);
  };
  return context.user ? (<Navigate to={location.state?.from || '/'} replace/>) 
  :(
    <div className="min-h-56 p-4 flex items-center justify-center">
      ...
      >
        ...
        <form className="flex flex-col items-center text-black text-lg w-2/3" onSubmit={handleSubmit}>
